...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "pandoc-mode-utils" '("latex" "jsmath" "mimetex" "wrap" "webtex" "katex" "base-header-level" "bibliography" "columns" "citation-abbreviations" "csl" "eol" "email-obfuscation" "epub-chapter-level" "number-offset" "indented-code-classes" "ipynb-output" "id-prefix" "track-changes" "tab-stop" "title-prefix" "reference-location" "shift-heading-level-by" "slide-level" "pandoc-" "pdf-engine" "def" "dpi" "highlight-style")))
